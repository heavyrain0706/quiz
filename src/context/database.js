export const geographyQuestions = [
            ...
            {
                questionText: 'Столица Зимбабве',
                answerOptions: [
                    {answerText: 'Киев', isCorrect: false},
                    {answerText: 'Хараре', isCorrect: true},
                    {answerText: 'Булавайо', isCorrect: false},
                    {answerText: 'Гверу', isCorrect: false}
                ]
            },
            {
                questionText: 'Самая длинная река в мире',
                answerOptions: [
            ...
            {
                questionText: 'Самая высокая гора в мире',
                answerOptions: [
                    {answerText: 'Канченджанга', isCorrect: false},
                    {answerText: 'Конгур', isCorrect: false},
                    {answerText: 'Джомолунгма', isCorrect: true},
                    {answerText: 'Чогори', isCorrect: false}
                ]
            },
            {
                questionText: 'Самый большой остров в мире',
                answerOptions: [
                    {answerText: 'Новая Гвинея', isCorrect: false},
                    {answerText: 'Мадагаскар', isCorrect: false},
                    {answerText: 'Суматра', isCorrect: false},
                    {answerText: 'Гренландия', isCorrect: true}
                ]
            },
            {
                questionText: 'Самое маленькое государство',
                answerOptions: [
            ...
            {
                questionText: 'Самый крупный город по площади',
                answerOptions: [
                    {answerText: 'Пекин', isCorrect: false},
                    {answerText: 'Нью-Йорк', isCorrect: false},
                    {answerText: 'Брисбен', isCorrect: false},
                    {answerText: 'Чунцин', isCorrect: true}
                ]
            },
            {
                questionText: 'Самый населенный город мира',
                answerOptions: [
                    {answerText: 'Дели', isCorrect: false},
                    {answerText: 'Токио', isCorrect: true},
                    {answerText: 'Сан-Паулу', isCorrect: false},
                    {answerText: 'Стамбул', isCorrect: false}
                ]
            },
            {
                questionText: 'Самый крупный по площади город США',
                answerOptions: [
                    {answerText: 'Хьюстон', isCorrect: false},
                    {answerText: 'Феникс', isCorrect: false},
                    {answerText: 'Оклахома-Сити', isCorrect: true},
                    {answerText: 'Лос-Анджелес', isCorrect: false}
                ]
            },
            {
                questionText: 'Самый населенный город США',
                answerOptions: [
                    {answerText: 'Нью-Йорк', isCorrect: true},
                    {answerText: 'Лос-Анджелес', isCorrect: false},
                    {answerText: 'Хьюстон', isCorrect: false},
                    {answerText: 'Чикаго', isCorrect: false}
                ]
            },
            {
                questionText: 'Самое глубокое озеро в мире',
                answerOptions: [
                    {answerText: 'Сан-Мартин', isCorrect: false},
                    {answerText: 'Адамс-Лейк', isCorrect: false},
                    {answerText: 'Танганьика', isCorrect: false},
                    {answerText: 'Байкал', isCorrect: true}
                ]
            },
            {
                questionText: 'Самая глубокая река в мире',
                answerOptions: [
                    {answerText: 'Янцзы', isCorrect: false},
                    {answerText: 'Конго', isCorrect: true},
                    {answerText: 'Дунай', isCorrect: false},
                    {answerText: 'Гудзон', isCorrect: false}
                ]
            },
            {
                questionText: 'Самый крупный лес в мире',
                answerOptions: [
                    {answerText: 'Тонгасс', isCorrect: false},
                    {answerText: 'Амазония', isCorrect: true},
                    {answerText: 'Сундарбан', isCorrect: false},
                    {answerText: 'Дейнтри', isCorrect: false}
                ]
            },
            {
                questionText: 'Самый глубокий каньон в мире',
                answerOptions: [
                    {answerText: 'Цангпо', isCorrect: true},
                    {answerText: 'Котауаси', isCorrect: false},
                    {answerText: 'Гандаки', isCorrect: false},
                    {answerText: 'Колка', isCorrect: false}
                ]
            },
            {
                questionText: 'Самая грязная река в мире',
                answerOptions: [
                    {answerText: 'Цитариум', isCorrect: true},
                    {answerText: 'Ганг', isCorrect: false},
                    {answerText: 'Ямуна', isCorrect: false},
                    {answerText: 'Буриганга', isCorrect: false}
                ]
            },
            {
                questionText: 'Самый глубокий океан в мире',
                answerOptions: [
                    {answerText: 'Атлантический', isCorrect: false},
                    {answerText: 'Северный Ледовитый', isCorrect: false},
                    {answerText: 'Тихий', isCorrect: true},
                    {answerText: 'Индийский', isCorrect: false}
                ]
            },
            {
                questionText: 'Самая большая страна Африки',
                answerOptions: [
                    {answerText: 'Республика Судан', isCorrect: false},
                    {answerText: 'Алжир', isCorrect: true},
                    {answerText: 'Ливия', isCorrect: false},
